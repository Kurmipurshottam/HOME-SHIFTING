"""
Django settings for Home_Shifting project.
...
SECRET_KEY = 'django-insecure-ohp5fsdht86g26#^_8^5v4f(azzz#$%)f1hg^r=406%)qpa)=t'
...
WSGI_APPLICATION = 'Home_Shifting.wsgi.application'
